...
def shape_element(element):
    ...
    if element.tag == "node" or element.tag == "way" :
        ...
        for k_value, v_value in element.items(): # iterate through the element
        ...
        for tag in element.iter("tag"): # iterating through tag
            ...
            # ignoring street values after the first one
            if ("street:" in second_k_value):
                continue
        ...
        # removing empty address and node_refs for assertion
